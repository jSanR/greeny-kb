...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * | LCTL |   Z  |   X  |   C  |   V  |   B  |-------.     ,------|   N  |   M  |   ,  |   .  |   -  |  {   |
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LCTL |      | LALT | NAV  | /Space  /       \Enter \  | Bspc | DRAW | HOME | END  |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
    [_BA] = LAYOUT(
    ...
    // `---------------+-------+-------+-------+-------+---------. ,-------+-------+-------+-------+-------+---------------´
    					KC_LCTL,XXXXXXX,KC_LALT,MO(_NV),KC_SPC,		SY_ENT,	KC_BSPC,TG(_DR),KC_HOME,KC_END
    //				   `-----------------------------------------´ `---------------------------------------´
    ),  
    [_GO] = LAYOUT(
    // ,-----------------------------------------------.				   ,-----------------------------------------------.
    ...
    // |-------+-------+-------+-------+-------+-------|				   |-------+-------+-------+-------+-------+-------|
        _______,_______,_______,_______,_______,_______,					C(KC_S),KC_B,	KC_E,	XXXXXXX,XXXXXXX,XXXXXXX,
    // |-------+-------+-------+-------+-------+-------|				   |-------+-------+-------+-------+-------+-------|
        _______,_______,_______,_______,_______,_______,					XXXXXXX,KC_LALT,KC_LGUI,KC_LCTL,XXXXXXX,KC_RSFT,
    // |-------+-------+-------+-------+-------+-------|				   |-------+-------+-------+-------+-------+-------|
        _______,_______,_______,_______,_______,_______,					KC_REDO,A(KC_M),XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
    // `---------------+-------+-------+-------+-------+---------. ,-------+-------+-------+-------+-------+---------------´
    					_______,_______,_______,_______,_______,	KC_ENT,	C(KC_Z),TG(_DR),XXXXXXX,XXXXXXX
    //				   `-----------------------------------------´ `---------------------------------------´
    ),   
    /*
     * SYMBOLS
