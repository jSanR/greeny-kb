...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // |-------+-------+-------+-------+-------+-------|				   |-------+-------+-------+-------+-------+-------|
        SC_LSPO,KC_A,	HR_SCTL,HR_DGUI,HR_FALT,KC_G,						KC_H,	HR_JALT,HR_KGUI,HR_LCTL,KC_SCLN,SC_RSPC,
    // |-------+-------+-------+-------+-------+-------|				   |-------+-------+-------+-------+-------+-------|
        KC_LCTL,KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,						KC_N,	KC_M,	KC_COMM,KC_DOT,	KC_MINS,KC_LBRC,
    // `---------------+-------+-------+-------+-------+---------. ,-------+-------+-------+-------+-------+---------------´
    					KC_LCTL,KC_LGUI,KC_LALT,MO(_NV),KC_SPC,		KC_ENT,	XXXXXXX,KC_RALT,KC_HOME,KC_END
    //				   `-----------------------------------------´ `---------------------------------------´
    ),
    [_NV] = LAYOUT(
    // ,-----------------------------------------------.				   ,-----------------------------------------------.
